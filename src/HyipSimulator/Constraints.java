...
public class Constraints {
	...
	public static final int OUTPUT_SHORTENER = (int) params.getInteger("output_shortener");
	...
	public static final double MUTATE_CHANCE = (double) params.getDouble("mutate_chance");
